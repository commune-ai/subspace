...
// 		//let neuron_uid = SubspaceModule::get_uid_for_key(netuid, &hotkey_id);
// 		let neuron_uid ;
//         match SubspaceModule::get_uid_for_key(netuid, &hotkey_id) {
//             Ok(k) => neuron_uid = k,
//             Err(e) => panic!("Error: {:?}", e),
//         } 
// 		//let neuron_uid_ex = SubspaceModule::get_uid_for_key(netuid_ex, &hotkey_id);
// 		let neuron_uid_ex ;
//         match SubspaceModule::get_uid_for_key(netuid_ex, &hotkey_id) {
