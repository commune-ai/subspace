...
impl<T: Config> Pallet<T> {
	pub fn do_update_global(origin: T::RuntimeOrigin, 
						max_name_length: u16,
		...
		Self::deposit_event(Event::GlobalUpdate( max_name_length, max_allowed_subnets, max_allowed_modules, max_registrations_per_block, unit_emission, tx_rate_limit));
		Ok(())
	}
}