...
pub mod v3 {
    ...
    pub mod old_storage {
        use super::*;
        use frame_support::{
            pallet_prelude::Identity, storage_alias, BoundedBTreeSet, DebugNoBound,
        };
        use parity_scale_codec::{Encode, MaxEncodedLen};
        use proposal::{ProposalData, ProposalId};
    ...
    impl<T: Config> OnRuntimeUpgrade for MigrateToV3<T> {
        fn on_runtime_upgrade() -> Weight {
            ...
            Proposals::<T>::translate(|_key, old: v3::old_storage::Proposal<T>| {
                Some(Proposal {
                    id: old.id,
            ...
            let senate_keys: [[u8; 32]; 7] = [
                [
                    0xdc, 0xba, 0x95, 0x80, 0x4d, 0x03, 0x39, 0x37, 0x0f, 0x8c, 0xb3, 0xfd, 0xa8,
                    0xa6, 0x41, 0xc4, 0xc5, 0x32, 0x4b, 0x89, 0xf9, 0xa1, 0x22, 0xf6, 0x61, 0x59,
                    0xd6, 0x88, 0xa3, 0x6e, 0xd5, 0x74,
                ],
                [
                    0x76, 0xb4, 0x34, 0x8c, 0xd6, 0xb8, 0xf4, 0x91, 0x99, 0x33, 0xcf, 0xea, 0x56,
                    0x12, 0x38, 0x54, 0x8c, 0x17, 0x30, 0x97, 0x36, 0x16, 0xfb, 0xf3, 0x03, 0x6e,
                    0x52, 0x2c, 0x59, 0x31, 0xde, 0x6b,
                ],
                [
                    0x0c, 0xb5, 0x18, 0xc7, 0x9e, 0xe5, 0x70, 0xbc, 0x13, 0x58, 0xda, 0x87, 0xed,
                    0xc2, 0x4b, 0xe6, 0x47, 0x98, 0x90, 0x2b, 0x84, 0x4a, 0x41, 0xf7, 0xe6, 0x0e,
                    0xa5, 0xb3, 0x70, 0xcd, 0xa2, 0x03,
                ],
                [
                    0x9a, 0xf3, 0xfc, 0x7e, 0xc1, 0x3d, 0xa8, 0x31, 0x19, 0x71, 0x11, 0x64, 0xc3,
                    0xdb, 0xb5, 0x8d, 0x51, 0x22, 0x6a, 0x91, 0x7f, 0x3f, 0xf5, 0x55, 0x6a, 0x0c,
                    0x4f, 0x7e, 0x6e, 0x26, 0x4f, 0x3b,
                ],
                [
                    0x54, 0x6a, 0x01, 0x08, 0xc3, 0x49, 0xba, 0x47, 0xd2, 0x2e, 0x9a, 0x2f, 0x8c,
                    0xed, 0x8e, 0x7d, 0x15, 0xae, 0x39, 0xc4, 0x5d, 0x06, 0x7c, 0xf4, 0x00, 0xc1,
                    0xc4, 0x0a, 0x74, 0xda, 0xfb, 0x39,
                ],
                [
                    0x3a, 0x87, 0x51, 0xeb, 0x50, 0x37, 0x25, 0x18, 0x8c, 0xe6, 0x13, 0x67, 0x61,
                    0x29, 0x9f, 0x6f, 0x66, 0x0b, 0x2d, 0x9d, 0xb6, 0xce, 0x8f, 0xdc, 0x12, 0xba,
                    0xa6, 0x98, 0x2f, 0x00, 0x18, 0x59,
                ],
                [
                    0xfc, 0x79, 0x26, 0xc0, 0x58, 0xe0, 0x40, 0x60, 0x1b, 0xb6, 0x1b, 0x73, 0x78,
                    0xe1, 0x28, 0x96, 0x0e, 0xe5, 0xda, 0x85, 0x11, 0x3c, 0x7a, 0x2a, 0x3b, 0xc7,
                    0x6f, 0xa0, 0x2b, 0x70, 0xa4, 0x3a,
                ],
            ];
