...
run-benchmarking:
	...
	./target/release/node-subspace benchmark pallet --chain specs/benchmark.json --pallet pallet_subspace --extrinsic "*" --steps 20 --repeat 10 --output pallets/subspace/src/wei.rs --template=./.maintain/frame-weight-template.hbs 