...
generate-benchmarks:
	...
	./target/release/node-subspace benchmark pallet --chain specs/benchmark.json --pallet pallet_subspace --extrinsic "*" --steps 20 --repeat 10 --output runtime/src/weights/pallet_subspace.rs --template=./.maintain/frame-weight-template.hbs 